...
With these rows removed, we can begin generating the columns that pull the values.

```{r}
university_enrollment_data 
```

We will now begin the columns that pull the actual values (NOTE THAT THIS DEVIATES FROM ORIGINAL PLAN - ACTUALLY JUST TAKES THE MOST RECENT VALUE FOR EAACH INDICATOR AT THE. COUNTRY LEVEL)
