...
As we can see, apart from some of the indicator-level omissions specified above, we have mostly complete data for the following 120 countries:
...
By matching the 120 land areas represented in the newly merged `university_impact_model` and the 258 land areas represented in `shapefile_data`. 
