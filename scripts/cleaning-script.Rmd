...
In the meantime, we can focus on constructing two new columns: (1) one that reflects total enrollment across all ISCED 6, 7, and 8 programs (i.e., `university_enrollment`), (2) another that reflects the proportion/percent of the national population that is school aged (i.e.,`proportion_school_aged`), and (3) one that reflects the proportion of the school-aged population that is enrolled in ISCED 6, 7, or 8 programs (i.e., `proportion_school_aged_enrolled`)
