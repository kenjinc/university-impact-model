...
For now, we focus on creating a choropleth map using `spatial_impact_data` indcating which and how many nation-states are being factored into our country-level and global results.
