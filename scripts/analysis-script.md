...
```
    ...
    ##     lending_group_dichotomy country_alpha_three
    ## 1                     Lower                 AFG
    ## 2                    Higher                 ALB
    ## 3                     Lower                 DZA
    ## 4                    Higher                 ARG
...
should also find which scneario greatest reduction by country - this
isn’t doing what it’s supposed to…….

``` r
impact_data %>%
  mutate(optimal_pattern=case_when(meatless_day_population_reduction_kg_co2e<low_red_meat_population_reduction_kg_co2e&no_red_meat_population_reduction_kg_co2e&no_dairy_population_reduction_kg_co2e&pescetarian_population_reduction_kg_co2e&lacto_ovo_vegetarian_population_reduction_kg_co2e&eat_lancet_population_reduction_kg_co2e&two_thirds_vegan_population_reduction_kg_co2e&vegan_population_reduction_kg_co2e~"Meatless Day",
                                   ...
                                   eat_lancet_population_reduction_kg_co2e<meatless_day_population_reduction_kg_co2e&low_red_meat_population_reduction_kg_co2e&no_red_meat_population_reduction_kg_co2e&no_dairy_population_reduction_kg_co2e&pescetarian_population_reduction_kg_co2e&lacto_ovo_vegetarian_population_reduction_kg_co2e&two_thirds_vegan_population_reduction_kg_co2e&vegan_population_reduction_kg_co2e~"EAT-Lancet",
                                    two_thirds_vegan_population_reduction_kg_co2e<meatless_day_population_reduction_kg_co2e&low_red_meat_population_reduction_kg_co2e&no_red_meat_population_reduction_kg_co2e&no_dairy_population_reduction_kg_co2e&pescetarian_population_reduction_kg_co2e&lacto_ovo_vegetarian_population_reduction_kg_co2e&eat_lancet_population_reduction_kg_co2e&vegan_population_reduction_kg_co2e~"Two-Thirds Vegan",
...
```
    ...
    ## 119                   0.550            Medium                Global South
    ## 120                   0.925         Very High                Global North
    ##     lending_group_dichotomy country_alpha_three optimal_pattern
    ## 1                     Lower                 AFG    Low Red Meat
    ## 2                    Higher                 ALB    Low Red Meat
    ## 3                     Lower                 DZA    Low Red Meat
    ## 4                    Higher                 ARG    Meatless Day
    ## 5                     Lower                 ARM    Low Red Meat
    ## 6                    Higher                 AUS    Meatless Day
    ## 7                    Higher                 AUT    Meatless Day
    ## 8                     Lower                 AZE    Low Red Meat
    ## 9                    Higher                 BRB    Meatless Day
    ## 10                   Higher                 BLR    Meatless Day
    ## 11                   Higher                 BEL    Meatless Day
    ## 12                   Higher                 BLZ    Meatless Day
    ## 13                    Lower                 BEN    Low Red Meat
    ## 14                   Higher                 BIH    Low Red Meat
    ## 15                   Higher                 BWA    Meatless Day
    ## 16                   Higher                 BRA    Meatless Day
    ## 17                   Higher                 BGR    Low Red Meat
    ## 18                    Lower                 BFA    Low Red Meat
    ## 19                    Lower                 CPV    Low Red Meat
    ## 20                    Lower                 KHM    Low Red Meat
    ## 21                    Lower                 CMR    Low Red Meat
    ## 22                   Higher                 CAN    Meatless Day
    ## 23                   Higher                 CHL    Low Red Meat
    ## 24                   Higher                 CHN    Low Red Meat
    ## 25                   Higher                 COL    Meatless Day
    ## 26                    Lower                 COG    Low Red Meat
    ## 27                   Higher                 CRI    Meatless Day
    ## 28                    Lower                 CIV    Meatless Day
    ## 29                   Higher                 HRV    Meatless Day
    ## 30                   Higher                 CYP    Meatless Day
    ## 31                   Higher                 CZE    Meatless Day
    ## 32                   Higher                 DNK    Meatless Day
    ## 33                   Higher                 ECU    Low Red Meat
    ## 34                    Lower                 EGY    Low Red Meat
    ## 35                    Lower                 SLV    Meatless Day
    ## 36                   Higher                 EST    Meatless Day
    ## 37                    Lower                 ETH    Low Red Meat
    ## 38                   Higher                 FJI    Low Red Meat
    ## 39                   Higher                 FIN    Meatless Day
    ## 40                   Higher                 FRA    Meatless Day
    ## 41                    Lower                 GEO    Meatless Day
    ## 42                   Higher                 DEU    Meatless Day
    ## 43                    Lower                 GHA    Low Red Meat
    ## 44                   Higher                 GRC    Meatless Day
    ## 45                    Lower                 GTM    Meatless Day
    ## 46                    Lower                 HND    Meatless Day
    ## 47                   Higher                 HKG    Meatless Day
    ## 48                   Higher                 HUN    Meatless Day
    ## 49                   Higher                 ISL    Meatless Day
    ## 50                    Lower                 IND    Meatless Day
    ## 51                    Lower                 IDN    Low Red Meat
    ## 52                   Higher                 IRN    Meatless Day
    ## 53                   Higher                 IRL    Meatless Day
    ## 54                   Higher                 ISR    Low Red Meat
    ## 55                   Higher                 ITA    Meatless Day
    ## 56                   Higher                 JAM    Meatless Day
    ## 57                   Higher                 JPN    Low Red Meat
    ## 58                    Lower                 JOR    Meatless Day
    ## 59                   Higher                 KAZ    Low Red Meat
    ## 60                    Lower                 KEN    Low Red Meat
    ## 61                   Higher                 KOR    Low Red Meat
    ## 62                   Higher                 KWT    Low Red Meat
    ## 63                    Lower                 KGZ    Low Red Meat
    ## 64                   Higher                 LVA    Meatless Day
    ## 65                   Higher                 LBN    Meatless Day
    ## 66                   Higher                 LTU    Low Red Meat
    ## 67                   Higher                 LUX    Meatless Day
    ## 68                   Higher                 MAC    Meatless Day
    ## 69                    Lower                 MDG    Meatless Day
    ## 70                    Lower                 MWI    Low Red Meat
    ## 71                   Higher                 MYS    Meatless Day
    ## 72                   Higher                 MDV    Meatless Day
    ## 73                    Lower                 MLI    Low Red Meat
    ## 74                   Higher                 MLT    Meatless Day
    ## 75                    Lower                 MRT    Meatless Day
    ## 76                   Higher                 MUS    Low Red Meat
    ## 77                   Higher                 MEX    Meatless Day
    ## 78                    Lower                 MDA    Meatless Day
    ## 79                   Higher                 MNE    Meatless Day
    ## 80                    Lower                 MAR    Meatless Day
    ## 81                   Higher                 NAM    Low Red Meat
    ## 82                    Lower                 NPL    Low Red Meat
    ## 83                   Higher                 NLD    Meatless Day
    ## 84                   Higher                 NZL    Meatless Day
    ## 85                    Lower                 NER    Low Red Meat
    ## 86                   Higher                 NOR    Low Red Meat
    ## 87                   Higher                 OMN    Meatless Day
    ## 88                    Lower                 PAK    Meatless Day
    ## 89                   Higher                 PAN    Low Red Meat
    ## 90                   Higher                 PER    Meatless Day
    ## 91                    Lower                 PHL    Low Red Meat
    ## 92                   Higher                 POL    Meatless Day
    ## 93                   Higher                 PRT    Meatless Day
    ## 94                   Higher                 ROU    Low Red Meat
    ## 95                   Higher                 RUS    Low Red Meat
    ## 96                    Lower                 RWA    Low Red Meat
    ## 97                   Higher                 SAU    Meatless Day
    ## 98                    Lower                 SEN    Meatless Day
    ## 99                   Higher                 SRB    Meatless Day
    ## 100                  Higher                 SVK    Meatless Day
    ## 101                  Higher                 SVN    Meatless Day
    ## 102                  Higher                 ZAF    Meatless Day
    ## 103                  Higher                 ESP    Meatless Day
    ## 104                   Lower                 LKA    Meatless Day
    ## 105                  Higher                 SWE    Meatless Day
    ## 106                  Higher                 CHE    Meatless Day
    ## 107                   Lower                 TZA    Low Red Meat
    ## 108                  Higher                 THA    Meatless Day
    ## 109                   Lower                 TGO    Low Red Meat
    ## 110                   Lower                 TUN    Meatless Day
    ## 111                  Higher                 TUR    Meatless Day
    ## 112                   Lower                 UGA    Low Red Meat
    ## 113                   Lower                 UKR    Meatless Day
    ## 114                  Higher                 GBR    Meatless Day
    ## 115                  Higher                 USA    Meatless Day
    ## 116                  Higher                 URY    Meatless Day
    ## 117                  Higher                 VEN    Meatless Day
    ## 118                   Lower                 YEM    Meatless Day
    ## 119                   Lower                 ZWE    Meatless Day
    ## 120                  Higher                 TWN    Low Red Meat
